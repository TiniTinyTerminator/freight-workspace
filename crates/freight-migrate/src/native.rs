...
use crate::fileapi as cmake_fileapi;
...
mod tests {
    ...
    fn walk_matches_so_no_srcs_listed() {
        ...
        freight::manifest::load_manifest_str(&toml).expect("renders valid toml");
    }
    ...
    fn extra_walked_file_is_negated() {
        ...
        freight::manifest::load_manifest_str(&toml).expect("valid toml");
    }
